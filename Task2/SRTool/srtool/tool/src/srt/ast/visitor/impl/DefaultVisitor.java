 ...
 * visit methods usually return the visited {@code Node}, or a different
 * {@code Node} object of the same type if the children were "modified" -- see
 * below. Subclasses can override {@code visit} methods to return something
 * different.
 * <p>
 * 
