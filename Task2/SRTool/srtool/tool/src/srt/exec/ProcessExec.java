...
public class ProcessExec {
	...
	/**
	 * Executes the command. Pipes the String "stdin" to the process. Waits for
	 * "timeout" seconds for the process to terminate. After calling this
	 * method, the fields "stdout" and "stderr" contain the contents of the
	 * stdout and stderr of the process. The stdout is also returned.
	 * 
	 * @param stdin
	 ...
	 */
	public String execute(String stdin, int timeout)
			throws ProcessTimeoutException, IOException, InterruptedException {
		...
		ByteArrayOutputStream stderrStream = new ByteArrayOutputStream(
				initialBufferLength);
		ByteArrayInputStream stdinStream = new ByteArrayInputStream(
				stdin.getBytes());
