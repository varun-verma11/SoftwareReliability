...
public class CLArgs implements Cloneable {
	...
	public static class ModeValidator implements IParameterValidator {
		...
		public void validate(String name, String value)
			...
			if (!value.equals(BMC) && !value.equals(VERIFIER)
					&& !value.equals(HOUDINI) && !value.equals(INVGEN)
					&& !value.equals(COMP)) {
	...
	@Parameter(names = { "--unsound", "-unsound", "-us" }, description = "If this option is included and "
